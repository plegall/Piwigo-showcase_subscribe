...
// | USA.                                                                  |
// +-----------------------------------------------------------------------+
$lang['(example: nature, landscape, portrait)'] = '(exemplo: a natureza, retrato, paisagem)';
$lang['Your subscription is currently pending, if you have provided an email, you will be notified as soon as your gallery is registered'] = 'Seu registro está pendente, se você registrou um email, será notificado logo que sua galeira for registrada.';
